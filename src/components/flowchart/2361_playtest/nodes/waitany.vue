...
import { type FlowchartDataNode_waitany } from '../types/script3'

// props were passed from the slot using `v-bind="customNodeProps"`
const props = defineProps<NodeProps<FlowchartDataNode_waitany['data']>>()
</script>
  ...
  <div>
    ...
    <div>
      <div>
        ...
        <span class="custom-node-title">{{ $t('comp.flowchart.node.waitany.title') }}</span>
      </div>
