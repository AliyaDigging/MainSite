...
import { type FlowchartDataNode_jump } from '../types/script3'

// props were passed from the slot using `v-bind="customNodeProps"`
const props = defineProps<NodeProps<FlowchartDataNode_jump['data']>>()
</script>
  ...
  <div>
    ...
    <div>
      <div>
        ...
        <span class="custom-node-title">{{ $t('comp.flowchart.node.jump.title') }}</span>
      </div>
