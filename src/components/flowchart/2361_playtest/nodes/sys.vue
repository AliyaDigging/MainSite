...
import { type FlowchartDataNode_sys } from '../types/script3'

// props were passed from the slot using `v-bind="customNodeProps"`
const props = defineProps<NodeProps<FlowchartDataNode_sys['data']>>()
</script>
...
<template>
  ...
  <div>
    ...
    <div>
      <div>
        <Icon class="custom-node-icon"><DeviceMobileMessage /></Icon>
        <span class="custom-node-title">{{ $t('comp.flowchart.node.sys.title') }}</span>
      </div>
