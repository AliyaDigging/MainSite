...
import StartAnCharacterChart from './nodes/StartAnCharacterChart.vue'
import InterruptChartAndCallCommand from './nodes/InterruptChartAndCallCommand.vue'
import WaitTimeForCondition from './nodes/WaitTimeForCondition.vue'
import EndWaitTimeForCondition from './nodes/EndWaitTimeForCondition.vue'
import PlayerInputWithOutDeleteField from './nodes/PlayerInputWithOutDeleteField.vue'
import TextFileCommand from './nodes/TextFileCommand.vue'
  ...
  <div style="width: 100%">
    ...
    <div v-else class="flowchart-comp">
      ...
      >
        ...
        <template #node-StartAnCharacterChart="props">
          <StartAnCharacterChart v-bind="props" />
        </template>
        <template #node-InterruptChartAndCallCommand="props">
          <InterruptChartAndCallCommand v-bind="props" />
        </template>
        <template #node-WaitTime="props">
          <WaitTime v-bind="props" />
        </template>
        <template #node-WaitTimeForCondition="props">
          <WaitTimeForCondition v-bind="props" />
        </template>
        <template #node-EndWaitTimeForCondition="props">
          <EndWaitTimeForCondition v-bind="props" />
        </template>
        ...
        <template #node-PlayerInputWithOutDeleteField="props">
          <PlayerInputWithOutDeleteField v-bind="props" />
        </template>
        <template #node-TextFileCommand="props">
          <TextFileCommand v-bind="props" />
        </template>
...
:deep(.vue-flow__node-EndWaitTimeForCondition),
...
:deep(.vue-flow__node-InterruptChartAndCallCommand),
:deep(.vue-flow__node-MonoBehavior),
:deep(.vue-flow__node-PlayerChoice),
:deep(.vue-flow__node-PlayerInputWithOutDeleteField),
:deep(.vue-flow__node-SetVariable),
:deep(.vue-flow__node-StartAnCharacterChart),
:deep(.vue-flow__node-TextFileCommand),
:deep(.vue-flow__node-Then),
:deep(.vue-flow__node-WaitTime),
:deep(.vue-flow__node-WaitTimeForCondition) {
  padding: 10px;
  border-radius: 3px;
  width: 220px;
  font-size: 12px;
