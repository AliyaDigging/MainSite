...
const messageTextList = computed(() => {
  const text = String(l10n.value[`AliyaMessage.${metadata.value.currName}.${props.data.itemId}.`])
  console.log(`AliyaMessage.${metadata.value.currName}.${props.data.itemId}.`)
  ...
  <div>
    ...
    <div>
      ...
      <div class="custom-node-content">
        ...
        <div v-if="props.data.messageText">
        ...
        <div v-if="props.data.imageId">
          ...
          <img
            ...
            :src="`/aliya/aliya1_android_dlc/images/${props.data.imageId}.png`"
            width="100%"
            class="mt-1"
          />
        </div>
