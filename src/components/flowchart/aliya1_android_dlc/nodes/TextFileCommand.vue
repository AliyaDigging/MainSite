...
const props = defineProps<NodeProps<FlowchartDataNode_TextFileCommand['data']>>()
</script>
  ...
  <div>
    ...
    <div>
      ...
      <div class="custom-node-content">
        {{ $t('comp.flowchart.aliya1_dlc.node.TextFileCommand.p.textfilekey') }}:“{{
          props.data.textFileKey
        }}”
      </div>
    </div>
