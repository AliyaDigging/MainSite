...
import { type FlowchartDataNode_Empty } from '../types/script3'

// props were passed from the slot using `v-bind="customNodeProps"`
const props = defineProps<NodeProps<FlowchartDataNode_Empty['data']>>()
</script>
...
<template>
  ...
  <div>
    ...
    <div>
      <div>
        <Icon class="custom-node-icon"><EllipsisHorizontalCircle /></Icon>
        <span class="custom-node-title">{{ $t('comp.flowchart.tysy_demo.node.Empty.title') }}</span>
      </div>
